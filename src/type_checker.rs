...
pub fn check_types(fdefs: &Vec<ast::Node<ast::TopDef>>, source: &str) -> Result<(), String> {
...
pub fn fn_env(fdefs: &Vec<ast::Node<ast::TopDef>>, source: &str) -> Result<HashMap<ast::Ident, ast::Type>, String> {
                        ...
                        (arg_type_node, arg_ident_node) => match arg_type_node.node(){
                            ...
                            ast::Type::FType(_, _) => {
                                let msg = format!("Nonprimitive arg {} of type {}",
                                    source_token(source, arg_ident_node.span()), source_token(source, arg_type_node.span()));
                                return Err(msg)
                            },
                        }
                    }
                        ...
                        let fn_prim = match fn_type {
                            ...
                            ast::Type::FType(_, _) => {
                                let msg = format!("Nonprimitive type {} of function {}",
                                    source_token(source, type_node.span()), source_token(source, ident_node.span()));
                                return Err(msg)
                            },
                        };
